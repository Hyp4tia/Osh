...
> [!NOTE]
> **تطبيق Osh حاليًا في مرحلة البيتا العامة (v1.0.2 Beta).** يجري العمل على صقل الميزات وتحسين الأداء باستمرار. إذا واجهتك أي مشكلة أو كان لديك اقتراح، يُرجى [فتح تذكرة على GitHub](https://github.com/Zeyadistired/Osh/issues)!
